...
public class Praktikum {
    public static void main(String[] args) {
        ...
        double rateUSD = rateClient.getRateUSD();
        double rateEUR = rateClient.getRateEUR();
        double rateJPY = rateClient.getURateJPY();

        Converter converter = new Converter(rateUSD, rateEUR, rateJPY);
